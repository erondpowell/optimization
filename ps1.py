###########################
# 6.00.2x Problem Set 1: Space Cows - Optimization, Brute Force, and Greedy Algorithms
...
# I could reverse keys and values for the cows,
# with a number as key and list of cow names as values.
# Then pop out the cow name when it comes time to layout the list.
